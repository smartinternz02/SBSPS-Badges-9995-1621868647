...
engine = create_engine("postgres://mwcohlgcrberdr:3640841f6d10ab44585cfce8ff90564d94d687c318f83aa38ecf54eeb9bff6e0@ec2-54-74-156-137.eu-west-1.compute.amazonaws.com:5432/d8urm4mv8npau3")
...
app.config['MAIL_USERNAME'] = 'ur email id'
...
def register():
    ...
    if request.method == "POST":
        ...
        msg = Message('Digital Payment Book', sender = 'arjunjakka@gmail.com', recipients = [username])
        msg.body = "Hello, "+username+ " Welcome to Digital Payment Book. You are now successfully registered"
        mail.send(msg)
...
def index():
    ...
    # User reached route via POST
        ...
        expenses = tendie_expenses.addExpenses(formData, session["user_id"], session["user_name"], mail)
